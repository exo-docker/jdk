...
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| **openjdk-25 + Ubuntu 26.04 (latest)** | `latest`, `25`, `25-ubuntu`, `25-ubuntu-26`, `25-ubuntu-2604`, `openjdk-25`, `openjdk-25-ubuntu`, `openjdk-25-ubuntu-26`, `openjdk-25-ubuntu-2604` | `openjdk-25/ubuntu/26.04/Dockerfile` |
| **openjdk-25 + Ubuntu 24.04**          | `25-ubuntu-24`, `25-ubuntu-2404`, `openjdk-25-ubuntu-24`, `openjdk-25-ubuntu-2404`                                                                 | `openjdk-25/ubuntu/24.04/Dockerfile` |
| **openjdk-21 + Ubuntu 26.04**          | `21`, `21-ubuntu`, `21-ubuntu-26`, `21-ubuntu-2604`, `openjdk-21`, `openjdk-21-ubuntu`, `openjdk-21-ubuntu-26`, `openjdk-21-ubuntu-2604`           | `openjdk-21/ubuntu/26.04/Dockerfile` |
| **openjdk-21 + Ubuntu 24.04**          | `21-ubuntu-24`, `21-ubuntu-2404`, `openjdk-21-ubuntu-24`, `openjdk-21-ubuntu-2404`                                                                 | `openjdk-21/ubuntu/24.04/Dockerfile` |
